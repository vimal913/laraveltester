            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right mb-2 d-flex justify-content-between">
                        <a class="btn btn-success" href="{{ route('companies.create') }}"><i class="fa-solid fa-plus"></i> New</a>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('companies.destroy',$company->id) }}" method="Post">
                                    <a class="btn btn-primary" href="{{ route('companies.edit',$company->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?');"><i class="fa-solid fa-trash-can"></i></button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
